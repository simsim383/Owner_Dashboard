...
import { CategoriesSection, TrendingSection, ReviewSection, ErosionSection, TopSellersSection, HiddenProfitSection, OpsSection, ActionsSection } from "./Sections.jsx";
...
const sectionGrid = sectionList.map(s => ({
  ...s,
  sub: { dashboard: "KPIs & insights", cats: "Revenue, profit, top/bottom", trending: "40%+ vs previous", review: "Low margin items", topsellers: "Best profit contributors", erosion: "Margin alerts", missing: "No cost data items", ops: "Daily patterns & basket", actions: "Prioritised to-do list", coming: "Events & prep", manage: "View & delete uploads", ai: "Ask about your data" }[s.id] || "",
}));
